...
if(isset($_GET['u'])){
    ...
    $user_to = $message_obj->getMostRecentUsers();
    if($user_to == false){
        $user_to = 'new';
    }
}
...
<div class="main_column column" id="main_column">
    ...
    <div class-"message_post">
        <form action="" method="POST">
            <?php
            if($user_to == "new"){
                echo "メッセージを送りたい友達を選んでください。<br><br>";
                ?>
                ...
                echo "<textarea name='message_body' id='message_textarea' placeholder='メッセージを入力'></textarea>";
                echo "<input type='submit' name='post_message' class='info' id ='message_submit' value='送信'>";
            }
            ?>
        </form>
    </div>
